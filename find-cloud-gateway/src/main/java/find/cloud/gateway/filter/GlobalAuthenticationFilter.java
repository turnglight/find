package find.cloud.gateway.filter;

import base.commons.model.TokenConstant;
import base.commons.response.ResponseResult;
import cn.hutool.core.codec.Base64;
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import find.cloud.gateway.model.SysConstant;
...
public class GlobalAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    private Mono<Void> invalidTokenMono(ServerWebExchange exchange) {
        return buildReturnMono(ResponseResult.invalidToken(), exchange);
    }


    private Mono<Void> buildReturnMono(ResponseResult resultMsg, ServerWebExchange exchange) {
